...
void setup()
{
  ...
  //sensor.writeReg(VL6180X::SYSRANGE__MAX_CONVERGENCE_TIME, 49);// 5 // init = 49
  //sensor.writeReg16Bit(VL6180X::SYSALS__INTEGRATION_PERIOD, 50);// 1 // init = 99
  //sensor.writeReg(VL6180X::READOUT__AVERAGING_SAMPLE_PERIOD, 24); // 6 //init = 48
