...
typedef enum { RUN_MODE_DEFAULT,
               RUN_MODE_TIMED,
               RUN_MODE_ASYNC,
               RUN_MODE_GPIO,
               RUN_MODE_CONT } runmode_t;
...
void setID() {
  ...
  Serial.println("LOX1 setAddress...");
  ...
  Serial.println("LOX2 setAddress...");
...
void setup() {
  ...
  setID();
  Serial.println("setID completed...");
}
